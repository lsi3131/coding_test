...
class Test(unittest.TestCase):
    def test_example1(self):
        ...
        self.assertTrue(canFinish(2, []))
        self.assertFalse(canFinish(20, [[5, 5]]))
        self.assertFalse(canFinish(3, [[0, 2], [1, 2], [2, 0]]))
        self.assertFalse(canFinish(20, [[0, 10], [3, 18], [5, 5], [6, 11], [11, 14], [13, 1], [15, 1], [17, 4]]))
        self.assertTrue(canFinish(5, [[1, 4], [2, 4], [3, 1], [3, 2]]))
        self.assertFalse(canFinish(8, [[1, 0], [2, 6], [1, 7], [5, 1], [6, 4], [7, 0], [0, 5]]))
        self.assertFalse(canFinish(5, [[1, 0], [2, 1], [3, 4], [4, 3]]))

    def test_performance(self):
        data = [[1, 0], [2, 0], [2, 1], [3, 1], [3, 2], [4, 2], [4, 3], [5, 3], [5, 4], [6, 4], [6, 5], [7, 5], [7, 6],
                ...
                [98, 97], [99, 97]]
        self.assertTrue(canFinish(100, data))
